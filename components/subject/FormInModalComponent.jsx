...
const FormComponent = ({ openDialog, setOpenDialog, onRefresh }) => {
  ...
  const inputClass = (touched, error) => `w-full px-4 py-2.5 bg-slate-50 dark:bg-[#1a1a1a] border rounded-xl focus:outline-none focus:ring-2 focus:border-transparent transition-all ${touched && error
              ...
              <form onSubmit={handleSubmit} className="space-y-6 flex flex-col h-full">
                ...
                <div className="flex items-center justify-end gap-4 pt-4 border-t border-slate-200 dark:border-slate-800 mt-auto">
                  ...
                  <button
                    type="submit"
                    disabled={!dirty || isSubmitting}
                    className={`flex items-center gap-2 px-8 py-2.5 rounded-xl font-semibold text-white shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer active:scale-95 ${title === "Update"
