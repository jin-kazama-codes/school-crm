...
const ImportComponent = ({ openDialog, setOpenDialog }) => {
    ...
    }, [skippedStudents.length, loading, skipped]);

    const downloadSkippedStudents = () => {
        const skippedData = skippedStudents.map(skp => {
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 space-y-6">
                        ...
                        {!loading && skippedStudents.length > 0 && (
                            <div className="border border-red-200 bg-red-50/50 p-6 rounded-xl mx-auto max-w-xl text-center">
                                <h3 className="text-xl font-bold text-red-700 mb-4">Skipped Students</h3>
                                ...
                                <button 
                                    onClick={downloadSkippedStudents}
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6 max-w-xl mx-auto w-full">
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                                <a href="https://ufile.io/se7xnfkd" target="_blank" rel="noreferrer" className="w-full sm:w-auto">
                                    <button
                                        type="button"
